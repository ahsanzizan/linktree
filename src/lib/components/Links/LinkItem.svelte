...
<a
	href={data.url}
	class="group relative inline-flex w-full items-center justify-center rounded-full border border-white px-4 py-[10px] text-sm text-white transition-all duration-500 hover:scale-105 hover:bg-white hover:text-black hover:drop-shadow-glow md:text-lg"
	target="_blank"
>
	<svg
		class="absolute left-5 top-1/2 -translate-y-1/2 fill-white transition-all duration-500 group-hover:fill-black"
		width="24px"
		height="24px"
		viewBox="0 0 512 512"
		id="icons"
